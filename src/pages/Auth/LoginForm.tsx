      ...
      <div className='flex flex-col justify-center min-h-screen '>
        ...
        <div className='flex md:flex-row space-x-12 justify-center items-center space-y-6 md:space-y-0 md:space-x-12'>
          <div className='flex flex-col items-center md:items-start text-center md:text-left space-y-6'>
            ...
            <p className='text-lg text-accent'>Sign in to your account</p>
          </div>

          {/* Right Column: Login Form (inside the box) */}
          <div className='md:w-1/3 border-1 border-accent rounded-xl shadow-lg p-12 pb-4 bg-background'>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-10'>
                ...
                <div className='relative'>
                  <input
                    ...
                    className='pl-2 peer h-14 w-full border-b-1 border-accent text-accent bg-transparent placeholder-transparent focus:outline-none focus:border-primary rounded-lg'
                    required
                    type='email'
                    {...register('email', {
                      required: true,
                  ...
                  <label
                    htmlFor='email'
                    className='mb-20 absolute left-0 -top-6 text-accent text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-accent peer-placeholder-shown:top-0 peer-focus:-top-4 peer-focus:text-primary peer-focus:text-sm'
                  >
                    Email address
                  </label>
                </div>
