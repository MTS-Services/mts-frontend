    ...
    <section className='lg:flex  items-center justify-between mx-auto gap-6 w-full max-w-screen-xl lg:py-24 md:pb-12 xl:py-24 py-4 px-[10px] md:px-[20px]'>
      ...
      <div className='flex flex-col md:flex-row items-center mx-auto justify-center w-full bg-card p-10 rounded-xl shadow-md shadow-box-style shadow-primary'>
        ...
        <div className='w-full md:w-1/2 text-center md:text-left'>
          ...
          <p className='text-sm text-accent  mb-2 font-primary '>
            {' '}
          ...
          <p className='text-xl  text-accent font-medium mb-2 font-primary border-b-1 pb-1 border-accent/20 flex items-center'>
            ...
            {/* Achievement icon */}
            Achieve Amount :{' '}
            <strong className='text-primary font-primary px-1'> $4800</strong>
          </p>
        ...
        <div className='flex items-center justify-center '>
          ...
          <div>
            <p className='text-lg text-accent italic max-w-2xl mx-auto font-primary'>
              We appreciate your trust in our team. Your satisfaction is our top
              priority. Let’s build something amazing together!
            </p>
          </div>
        </div>
